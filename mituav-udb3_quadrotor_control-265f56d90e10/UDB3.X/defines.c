...
extern _Q16 num0p998, num0p0001, num0p001, num0p05, num0p1, num0p2, num0p5, num0p8, num0p9, num0p95,
    num1p0, num1p1, num2p0, num4p0, num255, numPI, num2125, num875,
    num625, num1500, num2000, num1000, num10000, num500,
    num512, num3685, num14p45, num1024, num2048;
...
void InitCnsts(void) {
    ...
    num1p0 = _Q16ftoi(1.0);
    num0p05 = _Q16ftoi(0.02);
    num0p1 = _Q16ftoi(0.1);
    num0p2 = _Q16ftoi(0.2);
    num0p5 = _Q16ftoi(0.5);
    num0p8 = _Q16ftoi(0.8);
    num0p9 = _Q16ftoi(0.9);
    num0p95 = _Q16ftoi(0.98);
    num1p1 = _Q16ftoi(1.1);
    num2p0 = _Q16ftoi(2.0);
    int16_t tmp = 255;
